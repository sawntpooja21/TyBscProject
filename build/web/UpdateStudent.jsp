<%-- 
    ...
    Created on : 9 Jan, 2018, 8:13:31 AM
    Author     : SHREE
--%>
...
<ul>
   ...
   <form action="Update_Student" method="post">
            <div class="Add"><h2>UPDATE STUDENT</h2><div>
                    ...
                    <br></br>
                    <p> ROLL NUMBER<input type="text" name="rollno" pattern="[0-9].{3}" title="Enter Valid RollNo of Size 4" required="true"></p>
                    <p>ENTER CONTACT NO<input type="text" name="contact" pattern="[0-9].{9}" title="Enter Valid Contact No" required="true"></p>
                    
                    <p><input type="submit" value="Update" style="height:30px"></p>
                    </form>
